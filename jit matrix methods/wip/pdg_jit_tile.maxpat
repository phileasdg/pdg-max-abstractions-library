...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 90.0, 103.0, 70.0, 22.0 ],
					"text" : "jit.matrix #0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 399.0, 273.0, 70.0, 22.0 ],
					"text" : "jit.matrix #0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 399.0, 136.313124895095825, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 559.0, 228.0, 53.0, 22.0 ],
					"text" : "jit.matrix"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 399.0, 168.0, 40.0, 22.0 ],
					"text" : "uzi 11"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 312.0, 57.0, 150.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 399.0, 227.897046379745007, 136.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 92.0, 57.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "list", "", "", "" ],
					"patching_rect" : [ 79.0, 164.0, 293.58359132707119, 328.232198141515255 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "jit_matrix" ],
					"patching_rect" : [ 399.0, 199.0, 110.0, 22.0 ],
					"text" : "pdg_jit_seq -5 5 11"
				}
...
, 			{
				...
				"bootpath" : "~/Documents/Max 8/Library/jit matrix methods/wip",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
